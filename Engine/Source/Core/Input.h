...
namespace SnowEngine
{
	...
	public:
		...
		static b8 IsKeyPressed(Key key);

		static b8 IsMouseButtonPressed(Button button);
	...
	private:
		...
		static std::array<b8, 512> sKeys;
		static std::array<b8, 16> sButtons;
		static glm::vec2 sMousePosition;
		static glm::vec2 sMouseScroll;
